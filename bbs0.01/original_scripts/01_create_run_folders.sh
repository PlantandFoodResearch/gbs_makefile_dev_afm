...
BASEFOLDER="/dataset/semihybrid_ryegrass_GBS/active" # change
...
# following line creates symbolic links to the tutorial data
#ln -s /local_data/GBS/10244719_81PVTABXX_s_2_qseq.txt "$BASEFOLDER"/"$USER"/01_RawSequence/10244719_81PVTABXX_s_2_qseq.txt
#ln -s /local_data/GBS/10244719_81PVTABXX_s_3_qseq.txt "$BASEFOLDER"/"$USER"/01_RawSequence/10244719_81PVTABXX_s_3_qseq.txt
# following line creates symbolic links to the key file
#ln -s /local_data/GBS/rice.key "$BASEFOLDER"/"$USER"/50_KeyFiles/
# following line creates symbolic links to the bowtie2 aligner indices
#ln -s /local_data/GBS/OryzaSativa_Build7.* "$BASEFOLDER"/"$USER"/53_AlignerIdices/

echo "You are now ready to run the first step of the pipeline."